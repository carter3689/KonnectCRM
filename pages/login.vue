      ...
      <div class="mx-auto w-full max-w-sm lg:w-96">
        <div>
          ...
          <p class="mt-2 text-sm leading-6 text-gray-500">
            Not a member?
            {{ ' ' }}
            <a href="/signup" class="font-semibold text-indigo-600 hover:text-indigo-500">Start a 14 day free trial</a>
          </p>
        </div>
        ...
        <div class="mt-10">
          ...
          <div class="mt-10">
            ...
            <div class="mt-6 grid grid-cols-2 gap-4">
              <button @click="signinWithTwitter()" class="flex w-full items-center justify-center gap-3 rounded-md bg-[#1D9BF0] px-3 py-1.5 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1D9BF0]">
